 ...
 *                       the leases list — so a reject comes back there
 */
$uid = 'lm';
?>
<div class="modal" id="leaseCreateModal" data-modal <?= !empty($openCreateModal) ? 'data-modal-autoopen' : '' ?> hidden>
    <div class="modal__backdrop" data-modal-close></div>

    <div class="modal__dialog modal__dialog--lg" role="dialog" aria-modal="true"
         aria-labelledby="leaseCreateTitle" tabindex="-1">
        <header class="modal__header">
            <div>
                <h3 class="modal__title" id="leaseCreateTitle"><i class="bi bi-file-earmark-text"></i> New Lease</h3>
                <p class="modal__subtitle">The payment schedule is generated from these terms.</p>
            </div>
        ...
        <form class="modal__form" method="post" enctype="multipart/form-data" data-validate
              action="<?= APP_URL ?>/index.php?page=leases&amp;action=create">
            <?= csrfField() ?>
            ...
            <footer class="modal__footer">
                ...
                <span class="modal__footer-note">Need the full form? <a href="<?= APP_URL ?>/index.php?page=leases&amp;action=create">Open the page</a></span>
            </footer>
        </form>
    </div>
</div>
